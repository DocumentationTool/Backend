...
public class ResourceFunctions implements IDBFunctions, ResourceCalls{
	 ...
	 */
	private void updateResourceData(Connection connection, Path resourcePath, String data) throws CoreSqlException, ReadOnlyRepoException {
		if(database.getRepoProperties().isReadOnly()){
			throw new ReadOnlyRepoException("Repository is read only and cannot be edited!");
		}
	 ...
	 */
	public void batchInsertResources(List<Resource> resources) throws CoreSqlException, ReadOnlyRepoException {
	 ...
	 */
	public void batchUpdateResources(List<Resource> resources) throws CoreSqlException, ReadOnlyRepoException {
		if(database.getRepoProperties().isReadOnly()){
			throw new ReadOnlyRepoException("Repository is read only and cannot be edited!");
		}
		Connection connection = database.getConnection();
	 ...
	 */
	private void batchDeleteResources(List<Path> resourcePaths) throws CoreSqlException, ReadOnlyRepoException {
		if(database.getRepoProperties().isReadOnly()){
			throw new ReadOnlyRepoException("Repository is read only and cannot be edited!");
		}
		Connection connection = database.getConnection();
	...
	@Override
	public boolean removeResource(RepoId repoId, Path path) throws CoreSqlException, ReadOnlyRepoException {
		if(database.getRepoProperties().isReadOnly()){
			throw new ReadOnlyRepoException("Repository is read only and cannot be edited!");
		}
	...
	@Override
	public Resource updateResource(ResourceUpdateRequest request) throws CoreSqlException, ReadOnlyRepoException {
	...
	@Override
	public boolean moveResource(RepoId repoId, Path oldPath, Path newPath) throws CoreSqlException, ReadOnlyRepoException {
		if(database.getRepoProperties().isReadOnly()){
			throw new ReadOnlyRepoException("Repository is read only and cannot be edited!");
		}
