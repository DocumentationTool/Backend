...
/**
 * The Permission service that all interactions should be passed over when trying to interact with {@link com.wonkglorg.doc.core.db.functions.PermissionFunctions}, this service validates the user inputs beforehand
 */
@Component
